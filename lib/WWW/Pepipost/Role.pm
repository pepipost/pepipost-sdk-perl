...
has _cfg => ( is => 'ro',
              isa => 'Str',
              default => 'WWW::Pepipost::Configuration',
              );

has version_info => ( is => 'ro', 
                      isa => 'HashRef', 
                      default => sub { {
                          app_name => 'Pepipost API v1.0',
                          app_version => '1.0.0',
                          generated_date => '2016-04-20T12:50:43.667Z',
...
sub _build_af {
	...
	return WWW::Pepipost::ApiFactory->new(%args);
}

=head1 NAME

WWW::Pepipost::Role - a Moose role for the Pepipost API v1.0 

=head2 Pepipost API v1.0 version: 1.0.0
...
=item Build date: 2016-04-20T12:50:43.667Z
...
WWW::Pepipost::ApiFactory for non-Moosey usage. 
...
The tokens will be placed in the C<WWW::Pepipost::Configuration> namespace
as follows, but you don't need to know about this. 

=over 4

=item C<$WWW::Pepipost::Configuration::username>

String. The username for basic auth.

=item C<$WWW::Pepipost::Configuration::password>

String. The password for basic auth.

=item C<$WWW::Pepipost::Configuration::api_key>

Hashref. Keyed on the name of each key (there can be multiple tokens).

	$WWW::Pepipost::Configuration::api_key = {
		secretKey => 'aaaabbbbccccdddd',
		anotherKey => '1111222233334444',
		};

=item C<$WWW::Pepipost::Configuration::api_key_prefix>

Hashref. Keyed on the name of each key (there can be multiple tokens). Note not
all api keys require a prefix.

	$WWW::Pepipost::Configuration::api_key_prefix = {
		secretKey => 'string',
		anotherKey => 'same or some other string',
		};

=item C<$WWW::Pepipost::Configuration::access_token>
...
Returns an API factory object. You probably won't need to call this directly. 
        ...
        $self->api_factory('Pet'); # returns a WWW::Pepipost::PetApi instance
